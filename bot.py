...
async def membercount(ctx):
    ...
    em.add_field(name='<:offline:536240817552228385> Offline', value=f'{offline}')
    em.add_field(name='<:dnd:536240817531125760> DND', value=f'{dnd}')
    em.add_field(name='<:idle:536240817522868224> Idle', value=f'{idle}')
    em.add_field(name='<:online:536240817602560010> Online', value=f'{online}')
    em.timestamp = datetime.datetime.utcnow()
    await ctx.send(embed=em)
